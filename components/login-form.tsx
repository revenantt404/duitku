...
export function LoginForm({ autoFocus = false, onSuccess, onForgot }: { autoFocus?: boolean; onSuccess?: () => void; onForgot?: () => void }) {
  ...
  return (
    <div className="space-y-4">
      <Button
        ...
        disabled={loading}
      >
        {loading ? <Loader2 className="h-4 w-4 animate-spin" strokeWidth={1.75} /> : <GoogleIcon />}
      ...
      <form onSubmit={handlePasswordLogin} className="space-y-3">
        ...
        <div className="text-center">
          {onForgot ? (
            <button type="button" onClick={onForgot} className="text-[12px] font-medium text-ink dark:text-[#e9e6e2] hover:underline underline-offset-4 decoration-[#c9c5c0] dark:decoration-[#3a3a3a]">Lupa password?</button>
          ) : (
