    ...
    (
      ...
      >
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          ...
          <span style={{ fontSize: 12, letterSpacing: 3, textTransform: "uppercase", color: "#6b6b6b", border: "1px solid #e6e3df", borderRadius: 999, padding: "6px 12px", background: "#fff" }}>simpel / jujur / cepat</span>
        </div>
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          <div style={{ fontSize: 56, fontWeight: 700, lineHeight: 1, letterSpacing: -1.5, color: "#1a1a1a" }}>Catat Duit,<br />Jelas Hidup.</div>
          <div style={{ fontSize: 18, color: "#6b6b6b", lineHeight: 1.4, maxWidth: 560 }}>Dompet kepisah · limit budget · target nabung. Kelola uang tanpa ribet — simpel dan cepat.</div>
        </div>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end" }}>
          <div style={{ display: "flex", gap: 10 }}>
            ...
            <span style={{ fontSize: 13, color: "#fff", background: "#1a1a1a", border: "1px solid #1a1a1a", borderRadius: 999, padding: "8px 14px" }}>Transfer aman</span>
          </div>
